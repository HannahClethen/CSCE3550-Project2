# Google Gemini was used to assist in generate possible test cases for server
import unittest
import json
import time
...
# Use test database file with a separate name to avoid conflicts
...
class TestDatabaseManager(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # write custom insert logic here or modify db_manager to accept a filename.
        
        # generate and store test keys
        conn = sqlite3.connect(TEST_DB_FILE)
        cursor = conn.cursor()
        
        # Generate a test expired key (Jan 1, 2000)
        ...
        # Genertate another valid key with different expiry time - multiple valid keys test
    ...
    def test_01_get_valid_key(self):
        ...
        kid, key_pem = result
        # Set the expiry time using asser for the future
    ...
    def test_03_get_all_valid_public_keys(self):
        ...
        # Check that all retrieved keys are valid
...
class TestFlaskEndpoints(unittest.TestCase):
    ...
    def test_02_post_auth_valid(self):
        ...
        # Basic check to ensure the token is verifiable against the JWKS, use assert
